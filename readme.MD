...
Even though we will be putting he entier system in docker eventually, we should get the basics working first; notable putting our handlers and such within the module we created.
